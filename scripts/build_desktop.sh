...
sudo cp /vagrant/temp/temp_wallpaper.png /usr/share/lubuntu/wallpapers/sbl_reference_environment_chaste_wallpaper_1024x768.png

echo Setting wallpaper | tee -a $log
WALLPAPERPATH=/usr/share/lubuntu/wallpapers/sbl_reference_environment_chaste_wallpaper_1024x768.png
